# """
# login_window.py
# Login screen for Binod Book Binding Management System.
# """
...
#     def __init__(self):
#         super().__init__()
#         self.title("Binod Book Binding — Login")
#         self.resizable(False, False)
#         self.logged_in = False
#         self._center(440, 520)
#         self._build_ui()
...
#         # ── Banner ─────────────────────────────────────────────────────────────
#         banner = tk.Frame(self, bg=t["accent"], height=160)
#         banner.pack(fill="x")
#         banner.pack_propagate(False)

#         tk.Label(banner, text="📚", bg=t["accent"],
#                  font=("Segoe UI", 38)).pack(pady=(20, 4))
#         tk.Label(banner, text="Binod Book Binding",
#                  bg=t["accent"], fg="#ffffff",
#                  font=("Segoe UI", 17, "bold")).pack()
#         tk.Label(banner, text="Stationery Shop Management System",
#                  bg=t["accent"], fg="#c5cae9",
#                  font=FONTS["small"]).pack()

#         # ── Card ───────────────────────────────────────────────────────────────
#         card = tk.Frame(self, bg=t["card"], padx=40, pady=30)
#         card.pack(fill="both", expand=True, padx=30, pady=20)

#         tk.Label(card, text="Sign In", bg=t["card"], fg=t["text"],
#                  font=FONTS["heading"]).pack(anchor="w", pady=(0, 16))

#         self.user_entry = LabeledEntry(card, label="Username", width=30)
#         self.user_entry.pack(fill="x", pady=6)
#         self.user_entry.set("admin")

#         self.pass_entry = LabeledEntry(card, label="Password", width=30, show="●")
#         self.pass_entry.pack(fill="x", pady=6)
#         self.pass_entry.set("admin123")

#         # Error label
#         self.err_label = tk.Label(card, text="", bg=t["card"], fg=t["danger"],
#                                    font=FONTS["small"])
#         self.err_label.pack(anchor="w", pady=2)

#         FlatButton(card, text="Login", icon="🔐",
#                    command=self._login).pack(fill="x", pady=(14, 0))

#         # ── Footer ─────────────────────────────────────────────────────────────
#         tk.Label(self, text="Default: Chandan / Chandan@123",
#                  bg=t["bg"], fg=t["text2"], font=FONTS["small"]).pack(pady=6)
