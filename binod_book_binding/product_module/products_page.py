...
class ProductsPage(tk.Frame):
    ...
    # =========================================================
    # UPDATE STOCK AFTER PURCHASE (INTEGRATION METHOD)
    # =========================================================
    def update_stock_after_purchase(self, product_id, quantity_sold):
        """
        Update product stock after a bill is generated.
        Called by BillingPage after successful bill creation.
        
        Args:
            product_id: ID of the product to update
            quantity_sold: Quantity sold in the bill
        ...
        try:
            ...
            products = search_products(str(product_id))
            ...
            print(f"Stock updated: Product {product_id} - {current_qty} -> {new_qty}")
            ...
            print(f"Error updating stock after purchase: {e}")
            return False
    ...
    def refresh(self):
        """
        Refresh method that can be called externally.
        Refreshes the product list and dashboard.
        """
        self.load_products()
        self.refresh_dashboard()