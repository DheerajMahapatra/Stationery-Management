...
# """
# Professional Product Management – Delete no longer hangs
# Binod Book Binding
# """
...
#     # =========================================================
#     # UI (unchanged, but I include it for completeness)
#     # =========================================================
#     def build_ui(self):
#         t = self.t
...
#         # DELETE BUTTON – keep it (now safe)
#         tk.Button(btn_frame, text="🗑 Delete", bg="#ef4444", fg="white",
#                   activebackground="#dc2626", relief="flat", padx=14, pady=8,
#                   cursor="hand2", font=("Segoe UI", 10, "bold"),
#                   command=self.delete_product_ui).pack(side="left", padx=5)
...
#     # =========================================================
#     # HELPER: Run a function in a thread with timeout
#     # =========================================================
#     def _run_with_timeout(self, func, *args, timeout=3):
#         """
#         Execute func(*args) in a background thread.
...
#             return value
#         except queue.Empty:
#             raise TimeoutError("Database is busy. Please try again later.")
...
#         try:
#             # Run delete in background with timeout
#             result = self._run_with_timeout(delete_product, self.selected_id, timeout=3)

#             if isinstance(result, dict):
#                 if result.get("success"):
#                     messagebox.showinfo("Success", "Product Deleted Successfully")
#                 else:
#                     messagebox.showerror("Delete Failed", result.get("message", "Unable to delete product."))
#                     return
#             else:
#                 messagebox.showinfo("Success", "Product Deleted Successfully")
...
#         except TimeoutError:
#             messagebox.showerror("Database Busy",
#                                  "The database is currently locked.\n"
#                                  "Please wait a moment and try again.")
#         except sqlite3.IntegrityError:
#             # This happens when the product is used in bills
#             messagebox.showerror("Cannot Delete",
#                                  "This product is referenced in one or more bills.\n"
#                                  "Delete the related bills first before removing this product.")
#         except Exception as e:
#             messagebox.showerror("Error", str(e))
